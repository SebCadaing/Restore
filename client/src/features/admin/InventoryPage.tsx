...
export default function InventoryPage() {
  ...
  if (editMode) return <ProductForm setSelectedProduct={setSelectedProduct} refetch={refetch} setEditMode={setEditMode} product={selectedProduct} />;
          ...
          <TableBody>
            {data &&
              data.items.map((product) => (
                <TableRow key={product.id} sx={{ "&:last-child td, &:last-child th": { boder: 0 } }}>
